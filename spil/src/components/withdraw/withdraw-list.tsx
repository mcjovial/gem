...
import { IPaginator, Shop, Withdraw } from '@ts-types/generated';
...
const WithdrawList = ({ withdraws, onPagination }: IProps) => {
  ...
  return (
    <>
      ...
      {!!withdraws?.paginatorInfo.totalPages && (
        <div className="flex justify-end items-center">
          <Pagination
            total={withdraws?.paginatorInfo.totalPages}
            current={withdraws?.paginatorInfo.pagingCounter}
            pageSize={withdraws?.paginatorInfo.limit}
