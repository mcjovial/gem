        ...
        <View style={styles.container}>
          ...
          <View style={styles.totalCountWrapper}>
            <View style={styles.totalCountRow}>
              ...
              <Text style={styles.totalCountCell}>{order?.amount}</Text>
            </View>
            <View style={styles.totalCountRow}>
              <Text style={styles.totalCountCell}>Discount</Text>
              <Text style={styles.totalCountCell}>{order?.discount}</Text>
            </View>
            <View style={styles.totalCountRow}>
              <Text style={styles.totalCountCell}>Tax</Text>
              <Text style={styles.totalCountCell}>{order?.sales_tax}</Text>
            </View>
            <View style={styles.totalCountRow}>
              <Text style={styles.totalCountCell}>Delivery Fee</Text>
              <Text style={styles.totalCountCell}>{order?.delivery_fee}</Text>
            </View>
            <View style={styles.totalCountRow}>
              <Text
                style={[
